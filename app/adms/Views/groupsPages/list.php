...
<div class="container-fluid px-4">
    ...
    <div class="mb-1 hstack gap-2">
        <h2 class="mt-3">Grupos de Página</h2>
    ...
    <div class="card mb-4 border-light shadow">
        ...
        <div class="card-header hstack gap-2">
            ...
            <span class="ms-auto">
            <?php
                if (in_array('CreateGroupPage', $this->data['buttonPermission'])) {
                    echo "<a href='{$_ENV['URL_ADM']}create-group-page' class='btn btn-success btn-sm'><i class='fa-regular fa-square-plus'></i> Cadastrar</a> ";
                }
                ?>

                <!-- <a href="<?php echo $_ENV['URL_ADM']; ?>create-group-page" class="btn btn-success btn-sm"><i class="fa-regular fa-square-plus"></i> Cadastrar</a> -->
            </span>
        </div>
        ...
        <div class="card-body">
            ...
            // Verifica se há grupo no array
            if ($this->data['groupsPages'] ?? false) {
            ?>
                ...
                <form method="get" class="row g-2 mb-3 align-items-end">
                    ...
                    <div class="col-md-2 d-flex gap-2 align-items-end">
                        ...
                        <a href="list-groups-pages" class="btn btn-secondary btn-sm"><i class="fa fa-times"></i> Limpar filtro</a>
                    </div>
                </form>
                ...
                <div class="table-responsive d-none d-md-block">
                    <table class="table table-striped table-hover" id="tabela">
                        ...
                        <tbody>
                            <?php
                            foreach ($this->data['groupsPages'] as $groupPage) {
                                extract($groupPage); ?>
                                <tr>
                                    <td><?php echo $id; ?></td>
                                    <td><?php echo $name; ?></td>
                                    <td class="text-center">
                                        ...
                                        ?>
                                            <form id="formDelete<?php echo $id; ?>" action="<?php echo $_ENV['URL_ADM']; ?>delete-group-page" method="POST" class="d-inline">
                ...
                <div class="d-block d-md-none">
                        ...
                        <div class="card mb-3 shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="mt-2">
                                    ...
                                    if (in_array('DeleteGroupPage', $this->data['buttonPermission'])) {
                                    ?>
                                        <form id="formDeleteMobile<?= $id; ?>" action="<?= $_ENV['URL_ADM']; ?>delete-group-page" method="POST" class="d-inline">
                    ...
                    <div class="d-flex d-md-none flex-column align-items-center w-100 mt-2">
                        <div class="text-secondary small w-100 text-center mb-1">
                            ...
                            <?php else: ?>
                                Exibindo <?= count($this->data['groupsPages']); ?> registro(s) nesta página.
                            <?php endif; ?>
                        </div>
            ...
            <?php
            } else { // Exibe mensagem se nenhum grupo for encontrado
