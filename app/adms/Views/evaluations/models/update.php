...
<div class="container-fluid px-4">
    ...
    <div class="mb-1 hstack gap-2">
        <h2 class="mt-3">Editar Modelo de Avaliação</h2>
    ...
    <div class="card mb-4 border-light shadow">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="<?php echo $_ENV['URL_ADM']; ?>update-evaluation-model" id="formUpdateEvaluationModel">
                            ...
                            <?php if (isset($this->data['trainings']) && is_array($this->data['trainings'])): ?>
                                <?php foreach ($this->data['trainings'] as $training): ?>
                                    <option value="<?php echo $training['id']; ?>" 
                                            <?php echo (isset($this->data['form']['adms_training_id']) && $this->data['form']['adms_training_id'] == $training['id']) ? 'selected' : ''; ?>>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" name="SendEditEvaluationModel" class="btn btn-warning">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const form = document.getElementById('formUpdateEvaluationModel');
