...
<div class="container-fluid px-4">
    <div class="card mb-4 border-light shadow">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="<?= $_ENV['URL_ADM'] . 'view-receive/' . ($movement['movement_id'] ?? '') ?>" class="btn btn-outline-primary">Voltar</a>
        </div>
        <div class="card-body">
            <form method="POST">
                <div class="row">
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        <label for="method_id" class="form-label">Forma Recebimento</label>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="bank_id" class="form-label">Local de Entrada</label>
                ...
                <a href="<?= $_ENV['URL_ADM'] . 'view-receive/' . ($movement['movement_id'] ?? '') ?>" class="btn btn-secondary">Cancelar</a>
            </form>
        </div>
    </div>
</div> 