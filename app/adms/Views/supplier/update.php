    ...
    <div class="card mb-4 border-light shadow">
        ...
        <div class="card-body">
            ...
            <form action="" method="POST" class="row g-3">
                ...
                <input type="hidden" name="csrf_token" value="<?php echo CSRFHelper::generateCSRFToken('form_update_supplier'); ?>">

                <input type="hidden" name="id" id="id" value="<?php echo $this->data['form']['id'] ?? ''; ?>">

                <div class="col-4">
                    <label for="card_code" class="form-label">Codigo</label>
                    <input type="text" name="card_code" class="form-control" id="card_code" placeholder="Código Fornecedor." value="<?php echo $this->data['form']['card_code'] ?? ''; ?>"readonly>
                </div>

                <div class="col-4">
                    <label for="card_name" class="form-label">Nome</label>
                    <input type="text" name="card_name" class="form-control" id="card_name" placeholder="Nome Fornecedor." value="<?php echo $this->data['form']['card_name'] ?? ''; ?>">
                </div>
