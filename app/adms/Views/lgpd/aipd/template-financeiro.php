...
<div class="container-fluid px-4">
    ...
    <div class="mb-1 hstack gap-2">
        ...
        <ol class="breadcrumb mb-3 mt-3 ms-auto">
            ...
            <li class="breadcrumb-item">Template Financeiro</li>
        </ol>
    </div>

    <div class="alert alert-info">
        <h6><i class="fas fa-info-circle"></i> Template Específico para Setor Financeiro</h6>
        <p class="mb-0">
            <strong>Use este template para atividades que envolvem dados financeiros, bancários, pagamentos, 
            investimentos, seguros, etc.</strong><br>
            <strong>Exemplos práticos:</strong> Pagamento de folha, processamento de cartões de crédito, 
            transferências bancárias, gestão de investimentos, cobrança de clientes, emissão de boletos.
        </p>
    </div>
    ...
    <div class="alert alert-warning">
        ...
        <p class="mb-0">
            <strong>A AIPD deve estar vinculada a uma ROPA específica.</strong> A lista abaixo mostra ROPAs relevantes para o setor financeiro. 
    ...
    <div class="card mb-4 border-primary">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0">
                ...
                Avaliação de Impacto à Proteção de Dados - Setor Financeiro
            </h5>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="" method="POST" class="row g-3">
                <input type="hidden" name="csrf_token" value="<?php echo CSRFHelper::generateCSRFToken('form_template_financeiro'); ?>">

                <!-- Campos Específicos do Setor Financeiro -->
                <div class="col-12">
                    <div class="card border-primary">
                        <div class="card-header bg-primary text-white">
                            <h6 class="mb-0">Informações Específicas do Setor Financeiro</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="tipo_instituicao" class="form-label">
                                        <?php echo $this->data['template_financeiro']['campos_especificos']['tipo_instituicao']['label']; ?> *
                                    </label>
                                    <select name="tipo_instituicao" class="form-select" id="tipo_instituicao" required>
                                        <option value="">Selecione</option>
                                        <?php foreach ($this->data['template_financeiro']['campos_especificos']['tipo_instituicao']['options'] as $valor => $texto): ?>
                                            <option value="<?php echo $valor; ?>" 
                                                    <?php echo (isset($this->data['form']['tipo_instituicao']) && $this->data['form']['tipo_instituicao'] === $valor) ? 'selected' : ''; ?>>
                                ...
                                <div class="col-md-6">
                                    <label for="produto_financeiro" class="form-label">
                                        <?php echo $this->data['template_financeiro']['campos_especificos']['produto_financeiro']['label']; ?>
                                    </label>
                                    <select name="produto_financeiro" class="form-select" id="produto_financeiro">
                                        <option value="">Selecione</option>
                                        <?php foreach ($this->data['template_financeiro']['campos_especificos']['produto_financeiro']['options'] as $valor => $texto): ?>
                                            <option value="<?php echo $valor; ?>" 
                                                    <?php echo (isset($this->data['form']['produto_financeiro']) && $this->data['form']['produto_financeiro'] === $valor) ? 'selected' : ''; ?>>
                                                <?php echo htmlspecialchars($texto); ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="row mt-3">
                                <div class="col-12">
                                    <label class="form-label">
                                        <?php echo $this->data['template_financeiro']['campos_especificos']['dados_tratados']['label']; ?> *
                                    </label>
                                    <div class="row">
                                        <?php foreach ($this->data['template_financeiro']['campos_especificos']['dados_tratados']['options'] as $valor => $texto): ?>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <label for="base_legal" class="form-label">
                                        <?php echo $this->data['template_financeiro']['campos_especificos']['base_legal']['label']; ?> *
                                    </label>
                                    <select name="base_legal" class="form-select" id="base_legal" required>
                                        <option value="">Selecione</option>
                                        <?php foreach ($this->data['template_financeiro']['campos_especificos']['base_legal']['options'] as $valor => $texto): ?>
                                            <option value="<?php echo $valor; ?>" 
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input type="text" name="titulo" class="form-control" id="titulo" 
                                           value="<?php echo $this->data['form']['titulo'] ?? $this->data['template_financeiro']['titulo_padrao']; ?>" required>
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-12">
                                    ...
                                    <textarea name="objetivo" class="form-control" id="objetivo" rows="3" required><?php echo $this->data['form']['objetivo'] ?? $this->data['template_financeiro']['objetivo_padrao']; ?></textarea>
                                </div>

                                <div class="col-12">
                                    <label for="escopo" class="form-label">Escopo da AIPD *</label>
                                    <textarea name="escopo" class="form-control" id="escopo" rows="3" required><?php echo $this->data['form']['escopo'] ?? $this->data['template_financeiro']['escopo_padrao']; ?></textarea>
                                </div>

                                <div class="col-12">
                                    <label for="metodologia" class="form-label">Metodologia</label>
                                    <textarea name="metodologia" class="form-control" id="metodologia" rows="3"><?php echo $this->data['form']['metodologia'] ?? $this->data['template_financeiro']['metodologia_padrao']; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="riscos_identificados" class="form-control" id="riscos_identificados" rows="6"><?php 
                                        if (isset($this->data['form']['riscos_identificados']) && !empty($this->data['form']['riscos_identificados'])) {
                                            ...
                                            echo implode("\n• ", array_merge([''], $this->data['template_financeiro']['riscos_identificados']));
                                        }
                                    ?></textarea>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="medidas_mitigacao" class="form-control" id="medidas_mitigacao" rows="6"><?php 
                                        if (isset($this->data['form']['medidas_mitigacao']) && !empty($this->data['form']['medidas_mitigacao'])) {
                                            ...
                                            echo implode("\n• ", array_merge([''], $this->data['template_financeiro']['medidas_mitigacao']));
                                        }
                                    ?></textarea>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <textarea name="conclusoes" class="form-control" id="conclusoes" rows="3"><?php echo $this->data['form']['conclusoes'] ?? $this->data['template_financeiro']['conclusoes_padrao']; ?></textarea>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="recomendacoes" class="form-control" id="recomendacoes" rows="4"><?php 
                                        if (isset($this->data['form']['recomendacoes']) && !empty($this->data['form']['recomendacoes'])) {
                                            ...
                                            echo implode("\n• ", array_merge([''], $this->data['template_financeiro']['recomendacoes_padrao']));
                                        }
                                    ?></textarea>
                                </div>
                            </div>
                ...
                <div class="col-12">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Salvar AIPD - Setor Financeiro
                    </button>
