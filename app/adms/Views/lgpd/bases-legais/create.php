...
$csrf_token = CSRFHelper::generateCSRFToken('form_create_base_legal');
?>
<div class="container-fluid px-4">
    <div class="mb-1 hstack gap-2">
        <h2 class="mt-3">Cadastrar Base Legal LGPD</h2>
    ...
    <div class="card mb-4 border-light shadow">
        <div class="card-header hstack gap-2">
            <span><i class="fas fa-gavel me-2"></i>Cadastrar Base Legal</span>
        </div>
        <div class="card-body">
