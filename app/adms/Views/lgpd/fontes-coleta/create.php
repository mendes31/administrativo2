...
<div class="container-fluid px-4">
    ...
    <div class="mb-1 hstack gap-2">
        <h2 class="mt-3">Criar Fonte de Coleta</h2>
    ...
    <div class="card mb-4 border-light shadow">
        <div class="card-header">
            <h5 class="mb-0"><i class="fa-solid fa-plus-circle"></i> Nova Fonte de Coleta</h5>
        </div>
        <div class="card-body">
            <?php include './app/adms/Views/partials/alerts.php'; ?>

            <form method="POST" action="<?php echo $_ENV['URL_ADM']; ?>lgpd-fontes-coleta-store">
                <?php CSRFHelper::generateCSRFToken('form_create_fonte_coleta'); ?>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control" id="descricao" name="descricao" rows="3" 
                                  placeholder="Descreva detalhes sobre esta fonte de coleta..."></textarea>
