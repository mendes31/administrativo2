...
<div class="container-fluid px-4">
    ...
    <div class="mb-1 hstack gap-2">
        <h2 class="mt-3">
            ...
            Cadastrar Teste de Impacto às Atividades (TIA)
        </h2>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <form action="" method="POST" class="row g-3">
                <input type="hidden" name="csrf_token" value="<?php echo CSRFHelper::generateCSRFToken('form_tia'); ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="titulo" 
                                           name="titulo" 
                                           value="<?php echo htmlspecialchars($this->data['form']['titulo'] ?? ''); ?>"
                                    ...
                                    <select class="form-select" id="departamento_id" name="departamento_id" required>
                                        ...
                                        <?php foreach ($this->data['departamentos'] as $dept): ?>
                                            <option value="<?php echo $dept['id']; ?>" 
                                                    <?php echo (isset($this->data['form']['departamento_id']) && $this->data['form']['departamento_id'] == $dept['id']) ? 'selected' : ''; ?>>
                            ...
                            <div class="row mt-3">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              name="descricao" 
                                              rows="3" 
                                              placeholder="Descreva detalhadamente a atividade que será testada"><?php echo htmlspecialchars($this->data['form']['descricao'] ?? ''); ?></textarea>
                                    <div class="form-text">
                                    ...
                                    <select class="form-select" id="ropa_id" name="ropa_id">
                                        ...
                                        <?php foreach ($this->data['ropas'] as $ropa): ?>
                                            <option value="<?php echo $ropa['id']; ?>" 
                                                    <?php echo (isset($this->data['form']['ropa_id']) && $this->data['form']['ropa_id'] == $ropa['id']) ? 'selected' : ''; ?>>
                                    ...
                                    <select class="form-select" id="responsavel_id" name="responsavel_id">
                                        ...
                                        <?php foreach ($this->data['usuarios'] as $user): ?>
                                            <option value="<?php echo $user['id']; ?>" 
                                                    <?php echo (isset($this->data['form']['responsavel_id']) && $this->data['form']['responsavel_id'] == $user['id']) ? 'selected' : ''; ?>>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="date" 
                                           ...
                                           id="data_teste" 
                                           name="data_teste" 
                                           value="<?php echo $this->data['form']['data_teste'] ?? date('Y-m-d'); ?>"
                                           required>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="resultado" name="resultado" required>
                                        ...
                                        <option value="Baixo Risco" <?php echo (isset($this->data['form']['resultado']) && $this->data['form']['resultado'] === 'Baixo Risco') ? 'selected' : ''; ?>>Baixo Risco</option>
                                        <option value="Médio Risco" <?php echo (isset($this->data['form']['resultado']) && $this->data['form']['resultado'] === 'Médio Risco') ? 'selected' : ''; ?>>Médio Risco</option>
                                        <option value="Alto Risco" <?php echo (isset($this->data['form']['resultado']) && $this->data['form']['resultado'] === 'Alto Risco') ? 'selected' : ''; ?>>Alto Risco</option>
                                        <option value="Necessita AIPD" <?php echo (isset($this->data['form']['resultado']) && $this->data['form']['resultado'] === 'Necessita AIPD') ? 'selected' : ''; ?>>Necessita AIPD</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="status" name="status" required>
                                        ...
                                        <option value="Concluído" <?php echo (isset($this->data['form']['status']) && $this->data['form']['status'] === 'Concluído') ? 'selected' : ''; ?>>Concluído</option>
                                        <option value="Aprovado" <?php echo (isset($this->data['form']['status']) && $this->data['form']['status'] === 'Aprovado') ? 'selected' : ''; ?>>Aprovado</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              name="justificativa" 
                                              rows="3" 
                                              placeholder="Explique o motivo do resultado obtido"><?php echo htmlspecialchars($this->data['form']['justificativa'] ?? ''); ?></textarea>
                                    <div class="form-text">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              name="recomendacoes" 
                                              rows="3" 
                                              placeholder="Quais ações devem ser tomadas"><?php echo htmlspecialchars($this->data['form']['recomendacoes'] ?? ''); ?></textarea>
                                    <div class="form-text">
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-success">
                            <i class="fas fa-save me-2"></i>Salvar Teste TIA
                        </button>
                    </div>
                </div>
            </form>
