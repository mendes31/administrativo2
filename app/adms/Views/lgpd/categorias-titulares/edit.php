...
$csrf_token = CSRFHelper::generateCSRFToken('form_update_categoria_titular');
?>
<div class="container-fluid px-4">
    <div class="mb-1 hstack gap-2">
        <h2 class="mt-3">Editar Categoria de Titular LGPD</h2>
    ...
    <div class="card mb-4 border-light shadow">
        <div class="card-header hstack gap-2">
            <span><i class="fas fa-users me-2"></i>Editar Categoria de Titular</span>
        </div>
        <div class="card-body">
