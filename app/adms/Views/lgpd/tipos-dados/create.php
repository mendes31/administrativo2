...
$csrf_token = CSRFHelper::generateCSRFToken('form_create_tipo_dado');
?>
<div class="container-fluid px-4">
    <div class="mb-1 hstack gap-2">
        <h2 class="mt-3">Cadastrar Tipo de Dado LGPD</h2>
    ...
    <div class="card mb-4 border-light shadow">
        <div class="card-header hstack gap-2">
            <span><i class="fas fa-database me-2"></i>Cadastrar Tipo de Dado</span>
        </div>
        <div class="card-body">
            ...
            <form action="" method="POST" class="row g-3">
                ...
                <div class="col-md-6">
                    <label for="tipo_dado" class="form-label">Tipo de Dado <span class="text-danger">*</span></label>
                    <input type="text" name="tipo_dado" class="form-control" id="tipo_dado" value="<?php echo $this->data['form']['tipo_dado'] ?? ''; ?>" required>
                    <?php if (isset($this->data['errors']['tipo_dado'])): ?>
                        <div class="text-danger small"><?php echo $this->data['errors']['tipo_dado']; ?></div>
                    <?php endif; ?>
                </div>
                <div class="col-md-6">
