...
$csrf_token = CSRFHelper::generateCSRFToken('form_update_tipo_dado');
?>
<div class="container-fluid px-4">
    <div class="mb-1 hstack gap-2">
        <h2 class="mt-3">Editar Tipo de Dado LGPD</h2>
    ...
    <div class="card mb-4 border-light shadow">
        <div class="card-header hstack gap-2">
            <span><i class="fas fa-database me-2"></i>Editar Tipo de Dado</span>
        </div>
        <div class="card-body">
