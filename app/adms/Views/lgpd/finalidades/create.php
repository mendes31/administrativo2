...
$csrf_token = CSRFHelper::generateCSRFToken('form_create_finalidade');
?>
<div class="container-fluid px-4">
    <div class="mb-1 hstack gap-2">
        <h2 class="mt-3">Cadastrar Finalidade LGPD</h2>
    ...
    <div class="card mb-4 border-light shadow">
        <div class="card-header hstack gap-2">
            <span><i class="fas fa-bullseye me-2"></i>Cadastrar Finalidade</span>
        </div>
        <div class="card-body">
