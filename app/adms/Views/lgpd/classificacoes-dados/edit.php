...
$csrf_token = CSRFHelper::generateCSRFToken('form_update_classificacao_dados');
?>
<div class="container-fluid px-4">
    <div class="mb-1 hstack gap-2">
        <h2 class="mt-3">Editar Classificação de Dados LGPD</h2>
    ...
    <div class="card mb-4 border-light shadow">
        <div class="card-header hstack gap-2">
            <span><i class="fas fa-tags me-2"></i>Editar Classificação de Dados</span>
        </div>
        <div class="card-body">
