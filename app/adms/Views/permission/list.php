            ...
            <div class="sticky-top-container mb-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-end">
                        <button type="button" class="btn btn-primary btn-sm me-2" id="savePermissionsBtn" onclick="confirmAndSavePermissions()">
                                        ...
                                        if (!empty($this->data['pages'] ?? [])) {
                                            ...
                                            foreach ($groupedPages as $groupId => $pages) {
                                                ...
                                                foreach ($pages as $page) {
                                                    ...
                                                    echo '<input class="form-check-input permission-toggle" type="checkbox" id="permission_' . $page['id'] . '" data-page-id="' . $page['id'] . '" data-group="' . htmlspecialchars($groupId) . '"';
                                ...
                                if (!empty($this->data['pages'] ?? [])) {
                                    ...
                                    foreach ($groupedPages as $groupId => $pages) {
                                        ...
                                        foreach ($pages as $page) {
                                            ...
                                            echo '<input class="form-check-input permission-toggle" type="checkbox" id="mobile_permission_' . $page['id'] . '" data-page-id="' . $page['id'] . '" data-group="' . htmlspecialchars($groupId) . '"';
                                            if ($isAllowed) echo ' checked';
                                            echo ' onchange="togglePermission(this, ' . $page['id'] . ', \'' . htmlspecialchars($groupId) . '\')">';
