...
<div class="container-fluid px-4">
    ...
    <div class="mb-1 hstack gap-2">
        <h2 class="mt-3">Contas à Receber</h2>
        ...
        <ol class="breadcrumb mb-3 mt-3 ms-auto">
            ...
            <li class="breadcrumb-item">
                <a href="<?php echo $_ENV['URL_ADM']; ?>list-receipts" class="text-decoration-none">Conta à Receber</a>
            </li>
    ...
    <div class="card mb-4 border-light shadow">
        ...
        <div class="card-body">
            ...
            <form action="" method="POST" class="row g-3">
                ...
                <input type="hidden" name="csrf_token" value="<?php echo CSRFHelper::generateCSRFToken('form_create_receive'); ?>">
                ...
                <div class="col-md-4">
                    ...
                    <select name="partner_id" class="form-select" id="partner_id">
                        ...
                        <?php
                        if ($this->data['listCustomers'] ?? false) {
                ...
                <div class="col-3">
                    ...
                    <input type="date" name="due_date" class="form-control" id="due_date" value="<?php echo $this->data['form']['due_date'] ?? ''; ?>">
                </div>

                <div class="col-3">
                    <label for="expected_date" class="form-label">Previsão Recebimento</label>
                    <input type="date" name="expected_date" class="form-control" id="expected_date" value="<?php echo $this->data['form']['expected_date'] ?? ''; ?>" readonly>
                </div>
