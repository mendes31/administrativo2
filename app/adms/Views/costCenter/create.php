...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4 border-light shadow">
        ...
        <div class="card-body">
            ...
            <!-- Formulário para cadastrar um novo Centro de Custo -->
            <form action="" method="POST" class="row g-3">

                <input type="hidden" name="csrf_token" value="<?php echo CSRFHelper::generateCSRFToken('form_create_cost_center'); ?>">

                <div class="col-12">
                    <label for="name" class="form-label">Nome</label>
                    <input type="text" name="name" class="form-control" id="name" placeholder="Nome do Centro de Custo" value="<?php echo $this->data['form']['name'] ?? ''; ?>">
                </div>
