...
<div class="container-fluid px-4">
    ...
    <div class="mb-1 d-flex flex-column flex-sm-row gap-2">
        ...
        <ol class="breadcrumb mb-3 mt-0 mt-sm-3 ms-auto">
            ...
            <li class="breadcrumb-item">
                <a href="<?php echo $_ENV['URL_ADM']; ?>list-cost-center" class="text-decoration-none">Centro de Custo</a>
            </li>
    ...
    <div class="card mb-4 border-light shadow">
        ...
        <div class="card-body">
            ...
            <form action="" method="POST" class="row g-3">
                ...
                <input type="hidden" name="csrf_token" value="<?php echo CSRFHelper::generateCSRFToken('form_update_cost_center'); ?>">

                <input type="hidden" name="id" id="id" value="<?php echo $this->data['form']['id'] ?? ''; ?>">

                <div class="col-12">
                    <label for="name" class="form-label">Nome</label>
                    <input type="text" name="name" class="form-control" id="name" placeholder="Nome do Cenro de Custo" value="<?php echo $this->data['form']['name'] ?? ''; ?>">
                </div>
