            ...
            ?>
                ...
                <form method="get" class="row g-2 mb-3 align-items-end">
                    ...
                    <div class="col-md-2 d-flex gap-2 align-items-end">
                        ...
                        <a href="list-positions" class="btn btn-secondary btn-sm"><i class="fa fa-times"></i> Limpar filtro</a>
                    </div>
                </form>
                            ...
                            foreach ($this->data['positions'] as $position) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form id="formDelete<?php echo $id; ?>" action="<?php echo $_ENV['URL_ADM']; ?>delete-position" method="POST" class="d-inline">
                ...
                <div class="d-block d-md-none">
                    <?php foreach ($this->data['positions'] as $i => $position) { extract($position); ?>
                        <div class="card mb-3 shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="mt-2">
                                    ...
                                    <form id="formDeleteMobile<?= $id; ?>" action="<?= $_ENV['URL_ADM']; ?>delete-position" method="POST" class="d-inline">
                    ...
                    <div class="d-flex d-md-none flex-column align-items-center w-100 mt-2">
                        <div class="text-secondary small w-100 text-center mb-1">
                            ...
                            <?php else: ?>
                                Exibindo <?= count($this->data['positions']); ?> registro(s) nesta página.
                            <?php endif; ?>
                        </div>
