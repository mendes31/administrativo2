...
<div class="container-fluid px-4">
    <div class="mb-1 d-flex flex-column flex-sm-row gap-2">
        ...
        <ol class="breadcrumb mb-3 mt-0 mt-sm-3 ms-auto">
            ...
            <li class="breadcrumb-item"><a class="text-decoration-none" href="<?php echo $_ENV['URL_ADM']; ?>list-positions">Cargos</a></li>
    ...
    <div class="card mb-4 border-light shadow">
        <div class="card-header hstack gap-2">
            <span>Importar Cargos via CSV</span>
            <span class="ms-auto d-sm-flex flex-row">
                <a href="<?php echo $_ENV['URL_ADM']; ?>import-positions/template" class="btn btn-outline-secondary btn-sm me-1 mb-1">
        ...
        <div class="card-body">
            ...
            <form action="" method="POST" enctype="multipart/form-data" class="row g-3">
                <input type="hidden" name="csrf_token" value="<?php echo CSRFHelper::generateCSRFToken('form_import_positions'); ?>">
