...
/**
 * Classe ValidationCategoriaTitularService
 * 
 * Esta classe é responsável por validar os dados de um formulário de categoria de titular LGPD, aplicando regras de validação para criação e edição de categorias.
 ...
 */
class ValidationCategoriaTitularService
{
    /**
     * Validar os dados do formulário.
     * 
     * Este método valida os dados fornecidos no formulário de categoria de titular, aplicando diferentes regras dependendo se é uma criação ou edição de categorias.
     * 
    ...
    public function validate(array $data): array
    {
        ...
        if (!isset($data['id'])) {
            $rules['titular'] = 'required|uniqueInColumns:lgpd_categorias_titulares,titular';
        } else {
            // Para edição, adicionar validação de id e ignorar a própria categoria
            $rules['id'] = 'required|integer';
            $rules['titular'] = 'required|uniqueInColumns:lgpd_categorias_titulares,titular,' . $data['id'];
        }
        ...
        $messages = [
            ...
            'titular:required' => 'O campo titular é obrigatório.',
            'titular:uniqueInColumns' => 'Já existe uma categoria de titular cadastrada com este nome.',
        ];
