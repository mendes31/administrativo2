...
class BanksRepository extends DbConnection
{
    ...
    public function getBank(int $id): array|bool
    {
        ...
        $sql = 'SELECT id, bank_name, bank, account, agency, created_at, updated_at
                FROM adms_bank_accounts
                WHERE id = :id
                ORDER BY id DESC';
    ...
    public function createBank(array $data): bool|int
    {
        try {
            ...
            $sql = 'INSERT INTO adms_bank_accounts (bank_name, bank, account, agency, created_at) VALUES (:bank_name, :bank, :account, :agency, :created_at)';
    ...
    public function updateBank(array $data): bool
    {
        try {
            ...
            $sql = 'UPDATE adms_bank_accounts SET bank_name = :bank_name, bank = :bank, account = :account, agency = :agency, updated_at = :updated_at';
